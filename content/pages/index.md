...
sections:
  - type: GenericSection
    ...
    text: |
      ...
      Every stream, tip, subscription, and donation is logged and traceable back to its source. Your dashboard shows who supported you, how, when, and exactly how it converted to your payout — target 48 hours to your bank.
      ...
      Sign up and complete light verification. Connect your wallet and payout method. Upload a track, enter your collaborators, set percentage splits, choose your license. Select how fans support you: tips, recurring support, or project campaigns. Watch your live dashboard: plays, support, token flows, and fiat payouts. Join monthly voting rounds for micro-grants if you want deeper involvement.

      ## How It Works for Fans

      Discover artists in the scenes you care about. Stream, tip, or support specific projects directly. See a clear breakdown of every contribution — how much goes to the artist, collaborators, and the shared pool. Earn small rewards for real curation and participation, not empty clicks.
